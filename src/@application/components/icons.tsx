...
export const HeartOutline = (style: ImageStyle): IconElement => (
  <Icon {...style} name="heart-outline" />
);
export const ShoppingBagOutline = (style: ImageStyle): IconElement => (
...
export const PersonOutline = (style: ImageStyle): IconElement => (
